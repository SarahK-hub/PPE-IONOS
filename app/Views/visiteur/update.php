...
<form method="post" action="/visiteur/<?= $visiteur['ID'] ?>/update">
    ...
    <label>Rôle</label>
    <select name="roles">
    <option value="visiteur" <?= ($old['roles'] ?? $visiteur['roles']) === 'visiteur' ? 'selected' : '' ?>>Visiteur</option>
    <option value="comptable" <?= ($old['roles'] ?? $visiteur['roles']) === 'comptable' ? 'selected' : '' ?>>Comptable</option>
    </select>
