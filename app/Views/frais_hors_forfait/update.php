...
<body>
    ...
    <?php endif; ?>
      ...
      <form method="post"
      action="/index.php/frais_hors_forfait/<?= $frais_hors_forfait['id'] ?>/update">
    ...
    <input
        ...
        name="date"
        id="date_frais"
        value="<?= htmlspecialchars($old['date_frais'] ?? '', ENT_QUOTES); ?>"
        required
    >
</div>
   ...
   <a href="/index.php/frais_hors_forfait">Annuler</a>
</form>
