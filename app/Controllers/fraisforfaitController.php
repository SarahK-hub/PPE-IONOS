...
final class fraisforfaitController extends Controller
{
    ...
    public function create(): void
    {
        ...
        $this->render('fraisforfait/create', [
            ...
            'message' => $_SESSION['flash'] ?? '',
            'old'     => $_SESSION['old'] ?? ['libelle' => '', 'montant' => ''],
    ...
    public function store(): void
    {
        ...
        try {
            $id = fraisforfait::create($libelle, (float)$montant);
    ...
    public function save(int $id): void
    {
        ...
        if (isset($libelle) && mb_strlen($libelle) > 100) $errors['libelle'] = 'Le libellé ne doit pas dépasser 100 caractères.';
        ...
        try {
            fraisforfait::update($id, $libelle, $montant);
